...
<html lang="en" dir="ltr">
  <head>
    ...
    .parallax1 {
      background-image: url("./images/raybanback.jpg");
      height:100%;
      background-attachment: fixed;
      background-position: center;
      background-repeat: no-repeat;
    ...
    @media screen and (max-width:700px) {
      .parallax {
        background-image: url("./images/sunsmall.jpg");
        position: relative;
        margin-left: auto;
        margin-right: auto;
        width:100%;
      ...
      .parallax1 {
        background-image: url("./images/sunsmall2.jpg");
        height:100%;
        background-attachment: fixed;
        background-position: center;
        background-repeat: no-repeat;
  ...
  <body>
    <div class="head container-fluid-sm">
      ...
      <h1 class="text-center sunh">Sunglasses</h1>
      <div class="home">
    ...
    <div id="items" class="bg-light items container-sm pl-5">
      <?php
      $sql ="SELECT * FROM sunpage ORDER BY `date` DESC";
      $result=mysqli_query($conn,$sql);
      while ($row=mysqli_fetch_assoc($result)) {
       ?>
      <div class="div">
        <img src="./sunpage/<?php echo $row['sunpageimg'] ?>">
      </div>
      <?php
      }
       ?>
    ...
    <div class="foot container-sm input-group">
      <img src="./images/headsun.png" alt="">

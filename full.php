...
<html lang="en" dir="ltr">
  <head>
    ...
    .parallax {
      background-image: url("./images/newfullnaymar1.jpg");
      position: relative;
      margin-left: auto;
      margin-right: auto;
      width:100%;
    ...
    .parallax1 {
      background-image: url("./images/fullnaymarbig.jpg");
      height:100%;
      background-attachment: fixed;
      background-position: center;
      background-repeat: no-repeat;
  ...
  <body>
    <div class="head container-fluid-sm">
      ...
      <h1 class="text-center sunh">Fullframes</h1>
      <div class="home">
    ...
    <div id="items" class="bg-light items container-sm pl-5">
      <?php
      $sql ="SELECT * FROM fullframepage ORDER BY `date` DESC";
      $result=mysqli_query($conn,$sql);
      while ($row=mysqli_fetch_assoc($result)) {
       ?>
      <div class="div">
        <img src="./sunpage/<?php echo $row['fullpageimg'] ?>">
      </div>
      <?php
      }
       ?>
    ...
    <div class="foot container-sm input-group">
      <img src="./images/shopfull.png" alt="">
